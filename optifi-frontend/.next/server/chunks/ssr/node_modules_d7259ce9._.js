...
"[project]/node_modules/options/lib/options.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/ws/lib/ErrorCodes.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/ws/lib/BufferUtil.fallback.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/ws/lib/BufferUtil.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
 ...
 */ try {
    module.exports = (()=>{
        const e = new Error("Cannot find module '../build/Release/bufferutil'");
    ...
    try {
        module.exports = (()=>{
            const e = new Error("Cannot find module '../build/default/bufferutil'");
            e.code = 'MODULE_NOT_FOUND';
            throw e;
        })();
    } catch (e) {
        try {
            module.exports = __turbopack_context__.r("[project]/node_modules/ws/lib/BufferUtil.fallback.js [app-ssr] (ecmascript)");
        } catch (e) {
...
"[project]/node_modules/ws/lib/Sender.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
 ...
 * Copyright(c) 2011 Einar Otto Stangvik <einaros@gmail.com>
 * MIT Licensed
 */ var events = __turbopack_context__.r("[externals]/events [external] (events, cjs)"), util = __turbopack_context__.r("[externals]/util [external] (util, cjs)"), EventEmitter = events.EventEmitter, ErrorCodes = __turbopack_context__.r("[project]/node_modules/ws/lib/ErrorCodes.js [app-ssr] (ecmascript)"), bufferUtil = __turbopack_context__.r("[project]/node_modules/ws/lib/BufferUtil.js [app-ssr] (ecmascript)").BufferUtil;
/**
...
function getArrayBuffer(array) {
    var l = array.byteLength, buffer = new Buffer(l);
    for(var i = 0; i < l; ++i){
        buffer[i] = array[i];
    }
    return buffer;
...
"[project]/node_modules/ws/lib/Validation.fallback.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/ws/lib/Validation.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
 ...
 */ try {
    module.exports = (()=>{
        const e = new Error("Cannot find module '../build/Release/validation'");
        e.code = 'MODULE_NOT_FOUND';
        throw e;
    })();
} catch (e1) {
    try {
        module.exports = (()=>{
            const e = new Error("Cannot find module '../build/default/validation'");
            e.code = 'MODULE_NOT_FOUND';
            throw e;
        })();
    } catch (e) {
        try {
            module.exports = __turbopack_context__.r("[project]/node_modules/ws/lib/Validation.fallback.js [app-ssr] (ecmascript)");
        } catch (e) {
...
"[project]/node_modules/ws/lib/BufferPool.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/ws/lib/Receiver.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
 ...
 * Copyright(c) 2011 Einar Otto Stangvik <einaros@gmail.com>
 * MIT Licensed
 */ var util = __turbopack_context__.r("[externals]/util [external] (util, cjs)"), Validation = __turbopack_context__.r("[project]/node_modules/ws/lib/Validation.js [app-ssr] (ecmascript)").Validation, ErrorCodes = __turbopack_context__.r("[project]/node_modules/ws/lib/ErrorCodes.js [app-ssr] (ecmascript)"), BufferPool = __turbopack_context__.r("[project]/node_modules/ws/lib/BufferPool.js [app-ssr] (ecmascript)"), bufferUtil = __turbopack_context__.r("[project]/node_modules/ws/lib/BufferUtil.js [app-ssr] (ecmascript)").BufferUtil;
/**
 ...
 *
 * @api private
 */ Receiver.prototype.allocateFromPool = !isNodeV4 ? function(length, isFragmented) {
...
"[project]/node_modules/ws/lib/Sender.hixie.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
 ...
 * Copyright(c) 2011 Einar Otto Stangvik <einaros@gmail.com>
 * MIT Licensed
 */ var events = __turbopack_context__.r("[externals]/events [external] (events, cjs)"), util = __turbopack_context__.r("[externals]/util [external] (util, cjs)"), EventEmitter = events.EventEmitter;
/**
 ...
 */ Sender.prototype.send = function(data, options, cb) {
    ...
    var isString = typeof data == 'string', length = isString ? Buffer.byteLength(data) : data.length, writeStartMarker = this.continuationFrame == false, writeEndMarker = !options || !(typeof options.fin != 'undefined' && !options.fin), buffer = new Buffer((writeStartMarker ? 1 : 0) + length + (writeEndMarker ? 1 : 0)), offset = writeStartMarker ? 1 : 0;
 ...
 */ Sender.prototype.close = function(code, data, mask, cb) {
    ...
    this.isClosed = true;
    try {
        if (this.continuationFrame) this.socket.write(new Buffer([
            0xff
        ], 'binary'));
...
"[project]/node_modules/ws/lib/Receiver.hixie.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/ws/lib/WebSocket.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
 ...
 * Copyright(c) 2011 Einar Otto Stangvik <einaros@gmail.com>
 * MIT Licensed
 */ var util = __turbopack_context__.r("[externals]/util [external] (util, cjs)"), events = __turbopack_context__.r("[externals]/events [external] (events, cjs)"), http = __turbopack_context__.r("[externals]/http [external] (http, cjs)"), https = __turbopack_context__.r("[externals]/https [external] (https, cjs)"), crypto = __turbopack_context__.r("[externals]/crypto [external] (crypto, cjs)"), url = __turbopack_context__.r("[externals]/url [external] (url, cjs)"), fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)"), Options = __turbopack_context__.r("[project]/node_modules/options/lib/options.js [app-ssr] (ecmascript)"), Sender = __turbopack_context__.r("[project]/node_modules/ws/lib/Sender.js [app-ssr] (ecmascript)"), Receiver = __turbopack_context__.r("[project]/node_modules/ws/lib/Receiver.js [app-ssr] (ecmascript)"), SenderHixie = __turbopack_context__.r("[project]/node_modules/ws/lib/Sender.hixie.js [app-ssr] (ecmascript)"), ReceiverHixie = __turbopack_context__.r("[project]/node_modules/ws/lib/Receiver.hixie.js [app-ssr] (ecmascript)");
/**
 * Constants
...
"[project]/node_modules/ws/lib/WebSocketServer.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
 ...
 * Copyright(c) 2011 Einar Otto Stangvik <einaros@gmail.com>
 * MIT Licensed
 */ var util = __turbopack_context__.r("[externals]/util [external] (util, cjs)"), events = __turbopack_context__.r("[externals]/events [external] (events, cjs)"), http = __turbopack_context__.r("[externals]/http [external] (http, cjs)"), crypto = __turbopack_context__.r("[externals]/crypto [external] (crypto, cjs)"), url = __turbopack_context__.r("[externals]/url [external] (url, cjs)"), Options = __turbopack_context__.r("[project]/node_modules/options/lib/options.js [app-ssr] (ecmascript)"), WebSocket = __turbopack_context__.r("[project]/node_modules/ws/lib/WebSocket.js [app-ssr] (ecmascript)"), tls = __turbopack_context__.r("[externals]/tls [external] (tls, cjs)"), url = __turbopack_context__.r("[externals]/url [external] (url, cjs)");
/**
...
function handleHixieUpgrade(req, socket, upgradeHead, cb) {
    ...
    var onClientVerified = function() {
        var location = (req.headers['x-forwarded-proto'] === 'https' || socket.encrypted ? 'wss' : 'ws') + '://' + req.headers.host + req.url, protocol = req.headers['sec-websocket-protocol'];
...
"[project]/node_modules/ws/index.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
 ...
 * Copyright(c) 2011 Einar Otto Stangvik <einaros@gmail.com>
 * MIT Licensed
 */ module.exports = __turbopack_context__.r("[project]/node_modules/ws/lib/WebSocket.js [app-ssr] (ecmascript)");
module.exports.Server = __turbopack_context__.r("[project]/node_modules/ws/lib/WebSocketServer.js [app-ssr] (ecmascript)");
module.exports.Sender = __turbopack_context__.r("[project]/node_modules/ws/lib/Sender.js [app-ssr] (ecmascript)");
module.exports.Receiver = __turbopack_context__.r("[project]/node_modules/ws/lib/Receiver.js [app-ssr] (ecmascript)");
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ws$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/ws/index.js [app-ssr] (ecmascript)");
...
const WebSocket = (()=>{
    try {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ws$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__.WebSocket) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ws$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__.WebSocket;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ws$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__;
    }
})(); //# sourceMappingURL=index.js.map
}),
...
const version = '2.52.0'; //# sourceMappingURL=version.js.map
}),
...
//# sourceMappingURL=node_modules_d7259ce9._.js.map